...
6. Create ALB and associate with Instance which is launched in Mumbai region
7. Create CNAME record and associate with ALB URL
8. Create A record with Alias for ALB URL
9. Try to create a CNAME for root domain (example.com) with ALB URL – Shouldn’t work
10. Try to create a Alias for root domain (example.com) with ALB URL – should work
